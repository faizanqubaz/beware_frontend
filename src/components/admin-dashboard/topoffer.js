...
const AdminPortor = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        console.log('Ibex Photos State:', ibexphotos);
        console.log('Guide Photos State:', guidephotos);
    ...
    formData.append('longitude', longitude);
        ...
        try {
            const response = await axios.post('https://beware-seven.vercel.app/api/v2/ibex/topoffer', formDataObj, {
                headers: {
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="admin_portor_flex_1">
                    <div className="admin_portor_flex_1_conatiner">
                        ...
                        <select id="region" onChange={handleRegionChange} className="dropdown-input">
