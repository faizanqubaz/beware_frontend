...
const DiscountDetail = () => {
  ...
  const { item } = location.state || {}; // Add fallback in case `location.state` is undefined
  ...
  if (!item) {
    return <div>No data available.</div>; // Fallback UI if `item` is undefined
  }
    ...
    <div className='discount_detail_main_container'>
      ...
      <div className='discount_detail_image_main_container'>
        ...
        <div className='discount_detail_image_main_container_two'>
          {/* Check if guidephotos exists and has at least one element */}
          {item.guidephotos && item.guidephotos.length > 0 && (
            <div className='discount_detail_image_main_container_one_iamge_round_flex'>
              <img
                className='discount_detail_image_main_container_one_iamge_round'
                src={item.guidephotos[0].cloudinary_url}
                alt={item.guideName}
              />
              <div>
      ...
      <div className='discount_detail_dolar_main_container'>
        ...
        <div className='discount_detail_dolar_main_container_two'>
          ...
          <div className='discount_detail_dolar_main_container_two_dolar_button_head'>
            <button className='discount_detail_dolar_main_container_two_dolar_instant_button' onClick={handleEmailClick} style={{ cursor: 'pointer' }}>Instant booking via Gmail</button>
            <button className='discount_detail_dolar_main_container_two_dolar_whatsapp_button' onClick={handleWhatsAppClick} style={{ cursor: 'pointer' }}>Contact via whatsapp</button>
          </div>
